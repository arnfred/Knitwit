...
"""Module for converting between color spaces. Taken from scipy and modified
to remove dependencies on scipy.
...
:author: Jonas Toft Arnfred (removed dependency on scipy)
...
rgb_from_xyz = np.array([[ 3.24048134, -1.53715152, -0.49853633],
...
rgbcie_from_xyz = np.array([[ 0.41846571, -0.15866078, -0.08283493],
...
rgb_from_hed = np.array([[0.65, 0.70, 0.29],
                         [0.07, 0.99, 0.11],
                         [0.27, 0.57, 0.78]])
hed_from_rgb = np.array([[ 1.87798274, -1.00767869, -0.55611582],
...
hdx_from_rgb = np.array([[ 1.20013702, -0.6897672 ,  1.05605387],
...
fgx_from_rgb = np.array([[-0.42297694,  1.24783103,  0.17179157],
       [ 1.31456992, -0.68076182,  0.40618107],
       [ 0.3410859 , -0.04595167, -1.35241459]])
...
bex_from_rgb = np.array([[ 1.27238604, -0.70058186, -0.06873155],
       [-0.13335615,  1.03814099, -0.35754557],
       [ 0.03240123,  0.26316373,  1.22748921]])

# FastRed + FastBlue +  DAB
rgb_from_rbd = np.array([[0.21393921, 0.85112669, 0.47794022],
                         [0.74890292, 0.60624161, 0.26731082],
                         [0.268, 0.570, 0.776]])
rbd_from_rgb = np.array([[-1.32952977,  1.62200656,  0.26012351],
       [ 2.12970228, -0.1585391 , -1.25707624],
       [-1.10517567, -0.44372484,  2.12219118]])
...
gdx_from_rgb = np.array([[ 1.07756696, -0.21523401,  0.04528954],
       [-0.13968985,  0.63330975, -0.90942963],
       [-0.26954218,  0.89780433,  0.65236765]])
...
hax_from_rgb = np.array([[ 1.51369317, -1.01440242,  1.03438371],
       [ 0.45578726,  0.29161645, -1.32219815],
       [-1.06564612,  1.58763493,  0.90376953]])
...
bro_from_rgb = np.array([[ 1.22676889, -0.84839467,  0.30132221],
       [-0.06556826,  1.53612948, -0.80847705],
       [-0.11643952, -0.51280985,  1.36931159]])
...
bpx_from_rgb = np.array([[ 1.12901624, -0.561991  ,  0.48367952],
       [ 0.24230696,  0.59531707, -0.79784929],
       [-0.4364208 ,  0.92391394,  0.80829696]])
...
ahx_from_rgb = np.array([[ 1.7793645 , -1.02183021,  0.19629009],
       [-0.96840357,  1.61169739, -1.02449898],
       [-0.7141743 ,  0.98589348,  1.87825309]])
...
hpx_from_rgb = np.array([[ 1.79624863, -1.35324306, -0.5396002 ],
       [-0.40217098,  1.31464144, -0.19159602],
       [ 0.49097939, -0.2632255 ,  1.81718779]])
