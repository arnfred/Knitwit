...
headroom.init()}
map=L.map('osm-map').setView([53.372,-1.49],12);var accessToken='pk.eyJ1IjoiZHlua2Fya2VuIiwiYSI6ImNqb243aG9icDE1NW8za28xZmJvNWhneWIifQ.aMupWLW7MsCX8BeEJXs6vQ';L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}',{attribution:'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery © <a href="https://www.mapbox.com/">Mapbox</a>',maxZoom:18,id:'mapbox.streets',accessToken:accessToken,}).addTo(map);var myIcon=L.icon({iconUrl:'media/marker-icon.png',iconSize:[25,41],iconAnchor:[12,16],popupAnchor:[1,0],});var gerrys=L.marker([53.39295,-1.500793],{icon:myIcon}).addTo(map);gerrys.bindPopup("<a href='http://independent-sheffield.co.uk/gerrys-bakery-coffee-house/'>Gerry's Bakery and Coffee House</a>");var justNatural=L.marker([53.385682,-1.508276],{icon:myIcon}).addTo(map);justNatural.bindPopup("<a href='https://www.facebook.com/JustNat.Crookes'>Just Natural</a>");var birdsYard=L.marker([53.381712,-1.467587],{icon:myIcon}).addTo(map);birdsYard.bindPopup("<a href='http://birdsyard.co.uk/'>Birds Yard</a>");var seraphins=L.marker([53.351816,-1.487585],{icon:myIcon}).addTo(map);seraphins.bindPopup("<a href='https://en-gb.facebook.com/SeraphinsAbbeydale/'>Seraphins of Abbeydale</a>");var beeches=L.marker([53.393177,-1.500669],{icon:myIcon}).addTo(map);beeches.bindPopup("<a href='https://www.facebook.com/BeechesWalkley'>Beeches of Walkley</a>");var knab=L.marker([53.353396,-1.501463],{icon:myIcon}).addTo(map);knab.bindPopup("<a href='https://www.facebook.com/Knab-Farm-Shop-335477486662209/'>Knab Farm Shop</a>");var unionst=L.marker([53.378615,-1.470387],{icon:myIcon}).addTo(map);unionst.bindPopup("<a href='http://union-st.org'>Union St Cafe</a>");var popup=L.popup();function onMapClick(e){popup.setLatLng(e.latlng).setContent("You clicked the map at "+e.latlng.toString()).openOn(map);}
