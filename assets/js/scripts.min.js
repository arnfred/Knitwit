...
headroom.init()}
map=L.map('osm-map').setView([53.372,-1.49],12);var accessToken='pk.eyJ1IjoiZHlua2Fya2VuIiwiYSI6ImNqb243aG9icDE1NW8za28xZmJvNWhneWIifQ.aMupWLW7MsCX8BeEJXs6vQ';L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}',{attribution:'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery © <a href="https://www.mapbox.com/">Mapbox</a>',maxZoom:18,id:'mapbox.streets',accessToken:accessToken,}).addTo(map);var myIcon=L.icon({iconUrl:'media/marker-icon.png',iconSize:[25,41],iconAnchor:[12,16],popupAnchor:[1,0],});var gerrys=L.marker([53.39295,-1.500793],{icon:myIcon}).addTo(map);gerrys.bindPopup("<a href='http://independent-sheffield.co.uk/gerrys-bakery-coffee-house/'>Gerry's Bakery and Coffee House</a></br>299 South Rd, Sheffield S6 3TA");var justNatural=L.marker([53.385682,-1.508276],{icon:myIcon}).addTo(map);justNatural.bindPopup("<a href='https://www.facebook.com/JustNat.Crookes'>Just Natural</a><br/>209 Crookes, Sheffield S10 1TE");var beeches=L.marker([53.393177,-1.500669],{icon:myIcon}).addTo(map);beeches.bindPopup("<a href='https://www.facebook.com/BeechesWalkley'>Beeches of Walkley</a><br/>290 South Road, Sheffield S6 3TE");var porterBrook=L.marker([53.3674586,-1.4997752],{icon:myIcon}).addTo(map);porterBrook.bindPopup("<a href='http://www.porterbrookdeli.co.uk/'>Porter Brook Deli</a><br/>354 Sharrow Vale Rd, Sheffield S11 8QP");var unionst=L.marker([53.378615,-1.470387],{icon:myIcon}).addTo(map);unionst.bindPopup("<a href='http://union-st.org'>Union St Cafe</a><br/>18-20 Union St, Sheffield S1 2JP");var franklyDeer=L.marker([53.360147,-1.4795527],{icon:myIcon}).addTo(map);franklyDeer.bindPopup("<a href='http://www.franklymydeer.co.uk/'>Frnakly my Deer</a><br/>361 Abbeydale Rd, Sheffield S7 1FS");var volpe=L.marker([53.3600917,-1.4795546],{icon:myIcon}).addTo(map);volpe.bindPopup("<a href='https://www.volpebistro.co.uk/'>Volpe Bistro</a><br/>367 Abbeydale Rd, Sheffield S7 1FS");var ginger=L.marker([53.3769285,-1.5009313],{icon:myIcon}).addTo(map);ginger.bindPopup("<a href='https://www.gingersheffield.co.uk/'>Ginger</a><br/>486 Glossop Rd, Sheffield S10 2QA");var popup=L.popup();function onMapClick(e){popup.setLatLng(e.latlng).setContent("You clicked the map at "+e.latlng.toString()).openOn(map);}
if(debug==true){map.on('click',onMapClick);}})